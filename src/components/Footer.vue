...
<template>
    <footer class="bg-blue-200 text-white">
        <div class="w-[100%] mx-auto flex items-center justify-between px-6">
            <div class="w-[15%] flex items-center">
                <img src="/src/assets/images/logo.png" alt="">
            </div>

            <div class="w-[50%] text-center text-lg text-white">
                Discover more about our innovative <span class="font-semibold text-blue-500">Unigator</span> platform,
