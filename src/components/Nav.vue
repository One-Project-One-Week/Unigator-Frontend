...
<template>
    <section class="bg-[#AFDDFF]">
        <nav
            class="w-[100%] h-[80px] mx-auto  bg-gradient-to-r from-[#D4F6FF] via-[#C9E6F0] to-[] to-[90%] flex gap-2.5 fixed">
            ...
            <div class="w-[60%] h-full flex gap-[80px] justify-center items-center">
                <a class="font-bold text-[18px] text-black no-underline" href="your-link">Home</a>
                <a class="font-bold text-[18px] text-black no-underline" href="your-link">Universities</a>
