                ...
                <div class="lg:col-span-2">
                    <section v-if="activeTab === 'overview'" class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-10 justify-center align-center mt-10">
                            <div class="w-[47%] h-25 border-1 border-black rounded-md flex-column py-4 px-5">
                                <div class="flex gap-2 align-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-calendar mt-1" viewBox="0 0 16 16">
                                        <path
                            ...
                            <div class="w-[47%] h-25 border-1 border-black rounded-md flex-column py-4 px-5">
                                <div class="flex gap-2 align-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                        class="bi bi-award mt-1" viewBox="0 0 16 16">
                                        <path
                            ...
                            <div class="w-[47%] h-25 border-1 border-black rounded-md flex-column py-4 px-5">
                                <div class="flex gap-2 align-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                        class="bi bi-globe mt-1" viewBox="0 0 16 16">
                                        <path
                    ...
                    <section v-if="activeTab === 'programs'" class="mb-8">
                        ...
                        <div class="flex space-x-4">
                            <button class="bg-gray-200 rounded-full px-3 py-1 text-gray-700 text-sm">Bachelor's</button>
                            <button class="bg-gray-200 rounded-full px-3 py-1 text-gray-700 text-sm">Master's</button>
                            <button class="bg-gray-200 rounded-full px-3 py-1 text-gray-700 text-sm">Doctoral</button>
                        </div>
                    </section>
                    ...
                    <section v-if="activeTab === 'campus-life'" class="mb-8">
                        ...
                        <p class="text-gray-700">University of Oxford offers a vibrant campus experience with numerous
                        ...
                        <div class="flex-column mt-8">
                            ...
                            <p class="text-md text-gray-700">
                                Oxford offers a unique collegiate system where students belong to both the university
                                and one of the colleges. The university has over 400 clubs and societies covering a wide
                                range of interests.
                            </p>
                        </div>
                ...
                <div>
                    <section class="bg-white rounded-md shadow-md p-6 mb-8">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-600 text-sm">+44 (0) 1865 280000</p>
                        </div>
                        <div class="mb-4">
                    ...
                    <section class="bg-white rounded-md shadow-md p-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h4 class="font-semibold text-gray-700 text-sm">University of Cambridge</h4>
